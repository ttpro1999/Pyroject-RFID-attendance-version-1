...
//List of members
char *Name[MAX]={"Bao Nguyen","Loc dam","Cong Hoang"," Trung Hieu","Xuan Tien","Tien Thang","Tam Dat","Tien Dung","Van Long"};
//List of UIDs
...
const char* ssid     = "Pyralink Lab";
const char* password = "20171025";
